    ...
    <div class="post">
        <div id="Carousel2" class="carousel slide shadow-soft border border-light p-4 rounded" data-ride="carousel">
            <div class="carousel-inner rounded">
                <div class="carousel-item active">
                    <img class="d-block w-100" src="/images/home/{{$post->image}}" alt="First slide">
                </div>
            </div>
        </div>
        ...
        <div class="content mt-4">
            <div class="d-flex justify-content-between align-items-center post-group">
               <h5> <span class="card-text "><span class="far fa-calendar-alt mr-2"></span>{{$post->created_at->diffForHumans()}}</span></h5>
               <div class="d-flex ">
